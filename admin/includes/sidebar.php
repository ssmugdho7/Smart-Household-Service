...
{               ?>
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li>
                        <a href="sale-report.php"><i class="fa fa-files-o blue2_color"></i> <span>Sales Report</span></a>
                     </li>
                     <li>
                        <a href="view-feedback.php"><i class="fa fa-files-o blue2_color"></i> <span>Feedbacks</span></a>
                     </li>
